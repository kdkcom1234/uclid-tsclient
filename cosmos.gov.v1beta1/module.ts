...
export { MsgDeposit, MsgDepositResponse, TallyResult, GenesisState, Vote, MsgVoteResponse, MsgVote, QueryProposalsRequest, QueryParamsRequest, VotingParams, MsgSubmitProposal, QueryVotesResponse, QueryDepositRequest, QueryVotesRequest, QueryParamsResponse, QueryDepositResponse, Proposal, QueryProposalRequest, QueryProposalResponse, TallyParams, QueryProposalsResponse, QueryTallyResultResponse, MsgSubmitProposalResponse, MsgVoteWeighted, DepositParams, Deposit, QueryVoteResponse, QueryTallyResultRequest, QueryDepositsRequest, QueryDepositsResponse, MsgVoteWeightedResponse, WeightedVoteOption, TextProposal, QueryVoteRequest };
